...
### Papers ingested
- [[papers/2026-05/3d-gaussian-splatting]] (3D Gaussian Splatting for Real-Time Radiance Field Rendering, SIGGRAPH 2023)
- [[papers/2026-05/mip-splatting]] (Mip-Splatting: Alias-free 3D Gaussian Splatting, CVPR 2024)
- [[papers/2026-05/gaussian-opacity-fields]] (Gaussian Opacity Fields, 2024)
- [[papers/2026-05/street-gaussians]] (Street Gaussians: Modeling Dynamic Urban Scenes with Gaussian Splatting, ECCV 2024)
...
- Read [[papers/2026-05/vggt]] PDF in full detail (CVPR 2025 Best Paper, 20 pages)
...
- Read [[papers/2026-05/mobile-gs]] PDF in full detail (ICLR 2026, 19 pages)
...
- Updated [[papers/2026-05/3d-gaussian-splatting]] with new reference to Mobile-GS
...
- Created 2 new paper pages: [[papers/2026-06/add-slam]], [[papers/2026-06/roger-slam]]
...
- [[papers/2026-06/add-slam]] (ADD-SLAM, arXiv 2025) — adaptive dynamic dense SLAM, scene consistency analysis + temporal Gaussian model
- [[papers/2026-06/roger-slam]] (RoGER-SLAM, arXiv 2025) — robust SLAM for noise/low-light, SP-RoFusion + CLIP enhancement
- [[papers/2026-05/proxy-gs]] (Proxy-GS, arXiv 2025) — occlusion-aware rendering via fast proxy system
- [[papers/2026-05/wildgs-slam]] (WildGS-SLAM, arXiv 2025) — uncertainty-aware dynamic SLAM with DINOv2
- [[papers/2026-05/pseudo-depth-meets-gaussian]] (Pseudo Depth, arXiv 2025) — feed-forward pose prediction, 90% faster tracking
- [[papers/2026-05/langgs-slam]] (LangGS-SLAM, arXiv 2026) — real-time language-feature SLAM, Top-K rendering
- [[papers/2026-05/langsplat]] (LangSplat, CVPR 2024) — 3D language Gaussian splatting, 199x faster than LERF
- [[papers/2026-05/dr-splat]] (Dr. Splat, arXiv 2025) — direct language embedding registration without rendering
- [[papers/2026-05/g2-mapping]] (G²-Mapping, IEEE 2025) — general multi-sensor 3DGS mapping framework
- [[papers/2026-05/gaussnav]] (GaussNav, TPAMI 2025) — visual navigation with 3DGS for IIN task
- [[papers/2026-06/up-slam]] (UP-SLAM, ICRA 2026) — parallel tracking-mapping, probabilistic octree, open-set dynamics
- [[papers/2026-06/vimgs-slam]] (ViMGS-SLAM, Array 2026) — multi-scale ViT monocular 3DGS SLAM
- [[papers/2026-06/zero-shot-uav-navigation]] (Zero-Shot UAV Nav, arXiv 2026) — relightable 3DGS + RL forest navigation
...
- Rewrote [[papers/2026-06/add-slam]] with complete methodology, math formulations (scene consistency analysis, MobileSAM segmentation, temporal Gaussian model, tracking/mapping losses), experimental results (Bonn ATE 2.77 cm, TUM ATE 1.25 cm, PSNR 22.41 dB), and limitations
...
- Rewrote [[papers/2026-06/roger-slam]] with complete methodology (SP-RoFusion fusion, adaptive tracking with residual balancing, CLIP enhancement module), math formulations (Eq. 1-17), experimental results (Replica ATE 0.24 cm clean / 0.60 cm noise+low-light, 91% improvement over SplaTAM), and limitations
...
- Created 3 new paper pages: [[papers/2026-06/tvg-slam]], [[papers/2026-06/taming-the-light]], [[papers/2026-06/varsplat]]
...
### Papers ingested (shallow)
- [[papers/2026-06/tvg-slam]] (TVG-SLAM, arXiv 2025) — tri-view geometric constraints, RGB-only SLAM, 69% ATE reduction outdoor
- [[papers/2026-06/taming-the-light]] (Taming the Light, arXiv 2025) — IAN+DRB-Loss, illumination-invariant semantic SLAM
- [[papers/2026-06/varsplat]] (VarSplat, arXiv 2026) — per-splat variance, uncertainty-aware RGB-D SLAM

## 2026-06-11 — Deep read: Taming the Light
- Read Taming the Light from arXiv HTML (2511.22968v1) — full methodology and experiments
- Rewrote [[papers/2026-06/taming-the-light]] with complete methodology (IAN color quantization → 64-color palette, DRB-Loss SSIM-gated affine exposure compensation, illumination-invariant tracking with albedo matching), math formulations (Eq. 1-10), experimental results (Replica ATE 0.34 cm best, mIoU 92.69%), ablation (Full: Depth L1 0.25 vs Baseline 0.46), and limitations
