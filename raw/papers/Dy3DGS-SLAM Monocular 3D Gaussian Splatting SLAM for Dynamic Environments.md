...
source: "https://arxiv.org/abs/2506.05965"
author:
  - "[[Mingrui Li]]"
  - "[[Yiming Zhou]]"
  - "[[Hongxing Zhou]]"
...
published:
created: 2026-06-13
description: "Abstract page for arXiv paper 2506.05965: Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments"
tags:
  - "clippings"
---
## Title:Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments

[View PDF](https://arxiv.org/pdf/2506.05965) [HTML (experimental)](https://arxiv.org/html/2506.05965v1)
...
| --- | --- |
| Cite as: | [arXiv:2506.05965](https://arxiv.org/abs/2506.05965) \[cs.CV\] |
|  | (or [arXiv:2506.05965v1](https://arxiv.org/abs/2506.05965v1) \[cs.CV\] for this version) |
|  | [https://doi.org/10.48550/arXiv.2506.05965](https://doi.org/10.48550/arXiv.2506.05965) |

## Submission history

From: Yiming Zhou \[[view email](https://arxiv.org/show-email/7b8272cf/2506.05965)\]  
**\[v1\]** Fri, 6 Jun 2025 10:43:41 UTC (2,585 KB)

[Which authors of this paper are endorsers?](https://arxiv.org/auth/show-endorsers/2506.05965) | Disable MathJax ([What is MathJax?](https://info.arxiv.org/help/mathjax.html))