...
## 定义
DINOv2是Meta提出的自监督Vision Transformer（ViT），无需标注数据即可学习稠密视觉特征表示。其自监督训练使特征具有天然的跨视图对应能力。在3DGS中，DINOv2作为特征骨干被用于两个不同方向：[[papers/2026-05-09/vggt|VGGT]]用它做图像patchify和全局几何推理，[[papers/2026-05-21/wildgs-slam|WildGS-SLAM]]用其3D-aware微调版作为不确定性预测的特征提取器。
...
## 关联
- 用到DINOv2的论文: [[papers/2026-05-09/vggt]], [[papers/2026-05-21/wildgs-slam]], [[papers/2026-06-02/up-slam]]
