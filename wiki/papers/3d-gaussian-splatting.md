...
## 关联
- 被引用: [[papers/mip-splatting]], [[papers/gaussian-opacity-fields]], [[papers/street-gaussians]], [[papers/mobile-gs]], [[papers/langsplat]], [[papers/dr-splat]], [[papers/gs-livo]], [[papers/g2-mapping]], [[papers/proxy-gs]], [[papers/wildgs-slam]], [[papers/pseudo-depth-meets-gaussian]], [[papers/langgs-slam]]
...
- 衍生范式: [[concepts/mlp-based-3dgs]]（Scaffold-GS、Octree-GS、Proxy-GS等用MLP解码高斯属性的变体）
