...
- 单目SLAM同行: MonoGS (CVPR 2024), [[papers/2026-05-21/wildgs-slam]]（单目动态SLAM）, [[papers/2026-05-21/pseudo-depth-meets-gaussian]]（前馈式伪深度SLAM）
- RGB-D SLAM对比: [[papers/2026-06-02/up-slam]]（并行框架+概率八叉树）, [[papers/2026-05-15/g2-mapping]]（通用GS-SLAM）
